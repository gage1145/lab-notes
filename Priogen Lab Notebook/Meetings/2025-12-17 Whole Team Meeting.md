...
## **Attendees**
- Marc, Roxy, Nicole, Gage

## Overview
1. Revenue Update
	1. $350k in revenue
	2. 200% growth this year
	3. Need $450k to break even
2. Sales & Marketing
	1. Mississippi: $100k in testing
		1. soil mostly
		2. feeder swabs
	2. MNPROtein
		1. Consistent sales each quarter
		2. Making connections in human testing labs
	3. Venison kits
		1. A little up in sales v. last year
	4. Marketing Strategy
		1. LinkedIn presence
		2. Social media ads
		3. Developing logo / certification program for companies that make pet supplements
3. Lab Operations
	1. Major projects
		1. SD soil
		2. TPWD
		3. Michigan legal case
	2. Venison kits
	3. Discussion Points
		1. Database
			1. **Can PriLIMS automatically generate a report??**
4. R&D
	1. PrioVision
		1. Finalized PCB-controlled heater
		2. Breathable plate tape
		3. Ready for validation
		4. Next steps:
			1. Image processing
			2. 3D print units
			3. UL/ISDO certification
			4. Shipping with reagents
	2. Micro-QuIC
		1. Storage of reagents; can MNPROtein be stored with the master mix?
5. 2026 Strategy
	1. Increase revenue by ~30%.
	2. PrioVision
	3. Micro-QuIC
	4. Fundraising
		1. $5M